...
export const ExtensionEnvSchema = v.looseObject({
  ...
  VITE_MODE: v.optional(v.picklist(["development", "production"]), "development"),
  ...
  VITE_MANIFEST_VERSION: v.optional(v.pipe(v.string(), v.transform(Number), v.union([v.literal(2), v.literal(3)]))),
});
